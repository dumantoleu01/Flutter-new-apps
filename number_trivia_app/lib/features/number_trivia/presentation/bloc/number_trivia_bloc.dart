...
abstract class NumberTriviaBloc extends Cubit<NumberTriviaState> {
  NumberTriviaBloc(NumberTriviaState state) : super(state);

  Future<void> getRandomNumberTrivia();
  Future getConcreteNumberTrivia(String num);
}

class NumberTriviaBlocImpl extends Cubit<NumberTriviaState> {
  final GetConcreteNumberTrivia getConcreteNumberTrivia;
  final GetRandomNumberTrivia getRandomNumberTrivia;
  final InputConverter inputConverter;

  NumberTriviaBlocImpl({
