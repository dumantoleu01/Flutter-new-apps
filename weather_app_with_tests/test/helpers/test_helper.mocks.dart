...
// in weather_app_with_tests/test/helpers/test_helper.dart.
...
import 'package:weather_app_with_tests/core/error/failure.dart' as _i7;
...
/// A class which mocks [WeatheRemoteDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockWeatheRemoteDataSource extends _i1.Mock
    implements _i9.WeatheRemoteDataSource {
  MockWeatheRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }
